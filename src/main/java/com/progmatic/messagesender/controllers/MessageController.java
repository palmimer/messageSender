...
//                shortList = messageService.listAllMessages(messageCountToShow, inOrder, topicId, sender, text);
//            } else {
...
//        model.addAttribute("selectMessages", criteria.getSelectMessages());
    ...
    public String showSingleMessage(
        ...
        List<Message> comments = messageService.getCommentsOfMessage(messageId);
